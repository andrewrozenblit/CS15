...
int main() {
    ...
    for (int i = 0; i < num_planets; i++) {
        first_planet_linked_list.pushAtFront(planet_array[num_planets-1-i]);
    }
     ...
     */
    for (int i = 0; i < num_planets; i++) {
        second_planet_linked_list.pushAtBack(planet_array[num_planets-1-i]);
    }
    ...
    // reverse list here
    second_planet_linked_list.reverse();
